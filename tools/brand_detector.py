...
KNOWN_BRANDS = [
    ...
    ('45RPM',               ['45rpm', '45 rpm']),
    ('YOSHIKI HISHINUMA',   ['yoshiki hishinuma', 'hishinuma']),
    ('ZUCCA',               ['zucca']),
    ('TSUMORI CHISATO',     ['tsumori chisato', 'tsumori']),
    ('BLUE BLUE JAPAN',     ['blue blue japan']),
    ('FUMITO GANRYU',       ['fumito ganryu', 'ganryu']),
    ('NOIR KEI NINOMIYA',   ['noir kei ninomiya', 'kei ninomiya']),
    ('PLANTATION',          ['plantation']),
    ('PORTER BY YOSHIDA KABAN', ['porter yoshida', 'yoshida kaban', 'porter by yoshida']),
